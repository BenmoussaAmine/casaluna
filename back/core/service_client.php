...
try{        
        ...
        $mdp=$client->getMdp();
        $fidelite=$client->getFidelite();
        $datas = array(':identifiant'=>$identifiant, ':identifiant'=>$identifiant, ':nom'=>$nom,':prenom'=>$prenom,':age'=>$age,':sexe'=>$sexe,':adresse'=>$adresse,':email'=>$email,':mdp'=>$mdp,':fidelite'=>$fidelite);
        $req->bindValue(':identifiant',$identifiant);
        $req->bindValue(':nom',$nom);
        $req->bindValue(':prenom',$prenom);
        $req->bindValue(':age',$age);
